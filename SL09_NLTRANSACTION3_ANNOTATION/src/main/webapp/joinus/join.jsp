					...
					<form action="" method="post">
						...
						<div id="join-form" class="join-form margin-large" >						
							...
							<dl class="join-form-row birthday">
								...
								<dd class="join-form-data">								
	                                <span>
	                                    <input type="text" id="year" value="2000"/>년
	                                    <input type="text" id="month" value="12"/>월
	                                    <input type="text" id="day"  value="23"/>일
							...
							<dl class="join-form-row">
								...
								<dd class="join-form-data habit">
									...
									<input type="checkbox" name="habit" id="trip" value="trip" checked="checked" /><label for="trip">여행</label>
								</dd>
							</dl>						
						</div>
						<div id="buttonLine">
