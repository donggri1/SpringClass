		...
		<div id="join-form" class="join-form margin-large">
			<dl class="join-form-row">
				...
				<dd class="join-form-data">
					<input type="text" name="id" value="dcha" /> <input
			...
			<dl class="join-form-row">
				...
				<dd class="join-form-data">
					<input type="text" name="name" value="진돌" />
				</dd>
			</dl>
			<dl class="join-form-row">
			...
			<dl class="join-form-row birthday">
				...
				<dd class="join-form-data">
					<span> <input type="text" id="year" value="1998" />년 <input
						type="text" id="month" value="06" />월 <input type="text" id="day"
						value="29" />일 <input type="hidden" name="birth" id="birth" />
					</span>
					<script>
                                         $("#day").blur(function (){
                                            var year = $("#year").val();
			...
			<dl class="join-form-row">
				...
				<dd class="join-form-data">
					<input type="text" name="email" value="kim@naver.com" />
				</dd>
			</dl>
			<dl class="join-form-row">
				...
				<dd class="join-form-data habit">
					<input type="checkbox" name="habit" id="music" value="music" /><label
						...
						id="movie" value="movie" checked /><label for="movie">영화</label>
					<input type="checkbox" name="habit" id="trip" value="trip" checked /><label
						for="trip">여행</label>
				</dd>
			</dl>
		</div>
