				...
				<form action="" method="post">
					...
					<div id="join-form" class="join-form margin-large">
						...
						<dl class="join-form-row birthday">
							...
							<dd class="join-form-data">
								<span> <input type="text" id="year" value="1989" />년 <input
									type="text" id="month" value="12" />월 <input type="text"
									id="day" value="31" />일 <input type="hidden" name="birth"
									id="birth" /> <script>
										$("#day")
												.blur(
														function() {
									...
									value="Solar" id="IsLunar" checked />양력 <input type="radio"
						...
						<dl class="join-form-row">
							...
							<dd class="join-form-data">
								<input type="text" name="email" value="aa@naver.com" />
							</dd>
						</dl>
						<dl class="join-form-row">
							...
							<dd class="join-form-data habit">
								<input type="checkbox" name="habit" id="music" value="music"
									...
									name="habit" id="movie" value="movie" checked /><label
